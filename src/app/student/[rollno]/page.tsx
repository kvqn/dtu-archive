  ...
  return (
    <div className="flex w-full flex-col items-center pb-20">
      <div className="flex w-[90%] flex-col items-center gap-4">
        <h2 className="text-center font-geologica text-3xl">{name}</h2>
        <div className="grid w-full grid-cols-2 justify-evenly font-geist">
        ...
        <div className="flex w-full flex-col gap-6">
          {Array.from(new Set(grades.map((grade) => grade.semester))).map(
            (semester) => (
              <div
                key={semester}
                className="divide-y-black w-fulldivide-y divide-y-2 divide-black overflow-hidden rounded-xl border-2 border-black bg-emerald-100 shadow-lg"
              >
                <div className="p-2 text-center font-geologica text-xl">
                  Semester {semester}
                </div>
                <div className="flex flex-col items-center gap-2 py-2">
                  {grades
                    ...
                    .map((grade) => (
                      ...
                      >
                        <div className="w-[25%] bg-teal-200 py-1 text-center font-medium">
                          {grade.subject_code}
                        </div>
                ...
                <div className="flex w-full divide-x-2 divide-black bg-amber-100 font-geist">
